...
export const EXECUTIVE_DORK_CATEGORIES: ExecutiveDorkCategory[] = [
  {
    ...
    icon: '📱',
    description: 'Perfiles públicos del ejecutivo en LinkedIn, Facebook, Twitter, Instagram y TikTok',
    dorkTemplate: '"{TARGET}" (site:linkedin.com | site:facebook.com | site:twitter.com | site:instagram.com | site:tiktok.com)',
    severity: 'LOW',
    results: [],
  },
  {
